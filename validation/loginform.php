<?php
     ### to get the query string parameters (parameters sent the in the url)
    $errors= [];
if(isset($_GET["errors"])){
        # errors in form in string (json)
        $errors = $_GET["errors"];
        # conver the string to json object
        $errors = json_decode($errors);  # json object
...
<body>
    ...
    <div class="container">
        <div class="m-auto ">
        <h1 class="text-center">Login to the ITI web site</h1>
